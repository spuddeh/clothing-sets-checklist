...
<#
.SYNOPSIS
    One-time backfill of historical GitHub Releases for Clothing Sets Checklist.
...
.DESCRIPTION
    ...
    --latest=false so none of them steals "Latest" from the next real release (csc-v2.0.0+).
...
# Unpublished dev builds (1.0.1, 1.2.4, 1.3.0) are intentionally omitted.
$releases = @(
    @{ artifact='csc'; version='1.0.0'; zip='Clothing_Sets_Checklist_v1.0.0.zip'; changelog=$changelog }
    @{ artifact='csc'; version='1.1.0'; zip='Clothing_Sets_Checklist_v1.1.0.zip'; changelog=$changelog }
    @{ artifact='csc'; version='1.2.0'; zip='Clothing_Sets_Checklist_v1.2.0.zip'; changelog=$changelog }
    @{ artifact='csc'; version='1.2.1'; zip='Clothing_Sets_Checklist_v1.2.1.zip'; changelog=$changelog }
    @{ artifact='csc'; version='1.2.2'; zip='Clothing_Sets_Checklist_v1.2.2.zip'; changelog=$changelog }
    @{ artifact='csc'; version='1.2.3'; zip='Clothing_Sets_Checklist_v1.2.3.zip'; changelog=$changelog }
)
